...
<div class="form-group">
    {!! Form::label('description', 'About me', ['class' => 'col-sm-3 control-label']) !!}
    <div class="col-sm-6">
...
<div class="form-group">
    <label for="gender-sel" class="col-sm-3 control-label">Gender</label>
    <div class="col-sm-6">
...
<div class="form-group">
    <label for="country-sel" class="col-sm-3 control-label">Country</label>                    
    <div class="col-sm-6">
