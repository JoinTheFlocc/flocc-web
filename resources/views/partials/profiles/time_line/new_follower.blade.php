<h4>
    <i class="fa fa-user-plus"></i> <a href="{{ URL::route('events.event', ['slug' => $event_slug]) }}">New follower: {{ $event }}</a>
</h4>
<p>
    <a href="{{ URL::route('profile.display', ['id' => $user_id]) }}">{{ $user }}</a> start following
</p>
